...
- [brainstorming/step-ts.md](brainstorming/step-ts.md) — what it would take to stop shelling out to `step` (CA bootstrap / Google device-login / SSH certs) and which libraries to use instead of hand-rolling.
